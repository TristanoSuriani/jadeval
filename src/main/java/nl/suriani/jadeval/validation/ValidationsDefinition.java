 ...
 */
public class ValidationsDefinition {
	private final static Logger logger = Logger.getLogger(ValidationsDefinition.class.getName());
	 ...
	 * @return decisions
	 */
	public Validations build(File file) {
	 ...
	 * @return decisions
	 */
	public Validations build(InputStream inputStream) {
	 ...
	 * @return decisions
	 */
	public Validations build(List<String> decisionStatements) {
	 ...
	 * @return decisions
	 */
	public Validations build(String... decisionStatements) {
		return build(charStreamRetriever.get(decisionStatements));
	}
	...
	private Validations build(CharStream input) {
		try {
			...
			ValidationsCompiler decisionsCompiler = new ValidationsCompiler(conditionFactory, valueFactory);
